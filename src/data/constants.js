...
export const RANKING_DATA = [
    { rank: 1, name: '鉄板マスターJ', score: 12500, top: true },
    { rank: 2, name: 'マヨビーム', score: 9800, top: true },
    { rank: 3, name: 'ねこじた', score: 8400, top: true },
    { rank: 4, name: 'お好み焼き好き', score: 5000, top: false },
    { rank: 5, name: 'K.T', score: 4200, top: false },
];

export const ACTIVITIES_LINKS = [
    { id: 1, title: 'NinjaDAO', desc: '来風とコラボレーション！日本最大級のWeb3コミュニティ', url: 'https://www.ninja-dao.com/', icon: '🥷' },
    { id: 2, title: 'アニメ「クリプトニンジャ咲耶」', desc: 'YouTube・アマゾンプライムでも視聴可能！', url: 'https://www.youtube.com/show/SC7AezWrb4nkcLMzI5N9rFHw?season=2&sbp=CgEy', icon: '📺' },
    { id: 3, title: 'CryptoNinja Partners (CNP)', desc: '【みんなのらいふ食堂】スポンサーに！', url: 'https://www.cryptoninja-partners.xyz/', icon: '✨' },
    { id: 5, title: 'FiNANCiEコミュニティ', desc: '岡山初オープン！みんなのらいふ食堂 クラウドファンディングへの挑戦', url: 'https://financie.jp/users/okonomiyakib', icon: '🔥' },
];

export const GAMES_LINKS = [
    { id: 6, title: 'にんぷち', desc: 'おこビーがゲームに登場！？', url: 'https://www.cryptofantasy.net/ninjapetit/', icon: '🎮' },
    { id: 7, title: 'CNPバーニンウォーズ', desc: '無料ファミリーゲームで１位獲得！', url: 'https://prtimes.jp/main/html/rd/p/000000071.000012092.html', icon: '📱' },
    { id: 4, title: 'CNPトレカ', desc: '『チャンピオンシップ』全国大会３位入賞！', url: 'https://cnptcg.monolithos.co.jp/', icon: '🏆' },
];
